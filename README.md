...
- 下载 OEC/OEC-Turbo Armbian系统文件（如Armbian_25.08.0_rockchip_wxy-oect_bookworm_6.12.35_server_2025.07.01.img.gz）并解压，切忌不要下Armbian_*.*.*_rockchip_wxy-oec-replaced开头的。
##### 8.2.7.1 能够进入SSH后台
